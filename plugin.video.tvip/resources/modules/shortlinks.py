...
def Get():
	...
	m3u  = 'http:///get.php?username='+username+'&password='+password+'&type=m3u_plus&output=mpegts'
	...
	if not auth=="":
		request  = 'http://daletvplay.xyz/create.php?source=indexpage&url='+m3u+'&submit=Make+TinyURL%21&alias='
		xbmc.log(str(request))
		request2 = 'http://daletvplay.xyz/create.php?source=indexpage&url='+epg+'&submit=Make+TinyURL%21&alias='
